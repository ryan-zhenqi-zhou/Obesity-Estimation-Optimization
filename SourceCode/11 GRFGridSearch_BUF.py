...
if __name__ == '__main__':
    # Read the files
    X_socio_2 = pd.read_csv("../data/06 Data for Optimal GRF Search/03 BUF/X_sociodemo_train.csv", index_col='GEOID') # input
    ...
    for local_w in local_weight:
        for local_model_n in range(1,41,1):
            ...
            for train_index, test_index in ten_fold.split(X_socio_2):
                ...
                grf = GeographicalRandomForest(160, "sqrt", 47, local_w, local_model_n) 
    ...
    search_result.to_csv("../data/06 Data for Optimal GRF Search/03 BUF/search_result.csv") # input
